package e.nikhi.ambulancerider;
...
import e.nikhi.ambulancerider.Common.Common;
import e.nikhi.ambulancerider.Helper.CustomInfoWindow;
import e.nikhi.ambulancerider.Model.Rider;
...
public class Home extends AppCompatActivity
  ...
  //location
    ...
    private void requestPickupHere(String uid) {
        ...
        btnPickupRequest.setText("Getting your Ambulance Driver...");
    ...
    private void displayLocation() {
        ...
        if (mLastLocation != null) {
                ...
                Log.d("ATS",String.format("YOUR LOCATION WAS CHANGED : %f/%f",lattitude,longitude));
            }
         else
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                mMap.addMarker(new MarkerOptions()
                                              .position(new LatLng(location.latitude,location.longitude))
                                               ...
                                               .icon(BitmapDescriptorFactory.fromResource(R.drawable.ambulanceclipartrider)));
